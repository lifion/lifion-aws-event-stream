...
describe('lib/index', () => {
  ...
  test('Parser writing part of message A and then the rest of message A', () => {
    return new Promise((resolve) => {
      const parser = new Parser();
      parser.pipe(
        new Writable({
      ...
      parser.write(getSampleBuffer('halfMessage1'));
      parser.write(getSampleBuffer('halfMessage2'));
    });
  });
